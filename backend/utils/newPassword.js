    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #08349c; color: white;">
            <tr>
              <td>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="padding-right: 0px;padding-left: 0px;" align="center">
                  ...
                  <img align="center" border="0" src="cid:uniq-email.png" alt="image" title="image" style="color:white;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 22%;max-width: 39.6px;" width="39.6"/>
            ...
            <tr>
              <td style="letter-spacing: 2px; font-size: 15px; text-transform: uppercase; text-align: center; padding: 15px 0;">Password Reset Successfull!!</td>
            </tr>
          </table>
      ...
      <div align="center">
        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="/" style="height:40px; v-text-anchor:middle; width:274px;" arcsize="0%"  strokecolor="#000000" strokeweight="2px" fillcolor="#000000"><w:anchorlock/><center style="color:#ffffff;"><![endif]-->
          <a href="/" target="_blank" class="v-button v-size-width" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color:#ff6404; border-radius: 6px;-webkit-border-radius: 6px; -moz-border-radius: 6px; width:50%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word;  border-top-width: 2px; border-left-color: #000000;font-size: 18px;">
            <span style="display:block;padding:10px 20px 8px;line-height:120%;">Back To Website</span>
          </a>
