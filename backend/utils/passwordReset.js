const PasswordResetTemplate = (url)=>{
    ...
    <div class="fullWidth" style="max-width: 350px;"><img alt="reset-password" src="cid:uniq-resetpass.gif" style="display: block; height: auto; border: 0; width: 100%;" title="reset-password" width="350"/></div>
    </div>
    </td>
    </tr>
    </table>
    ...
    <p style="margin: 0; word-break: break-word;"><span>This link will expire in 24 hours. If you continue to have problems</span><br/><span>please feel free to contact me at <a href="mailto:support@youremail.com" rel="noopener" style="text-decoration: underline; color: #393d47;" target="_blank" title="support@youremail.com">ekansha13@gmail.com</a>. <a href="Example.com" rel="noopener" style="text-decoration: underline; color: #393d47;" target="_blank">UNSUBSCRIBE</a></span></p>
    </div>
    </td>
    </tr>
    </table>
    ...
    <tr>
    <td style="vertical-align: middle; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 5px; padding-right: 6px;"><a href="http://designedwithbeefree.com/" style="text-decoration: none;" target="_blank"><img align="center" alt="Beefree Logo" class="icon" height="32" src="cid:uniq-Beefree.png" style="display: block; height: auto; margin: 0 auto; border: 0;" width="34"/></a></td>
